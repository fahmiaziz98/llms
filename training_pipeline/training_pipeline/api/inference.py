...
class InferenceAPI:
    ...
    def __init__(
        ...
        self._prompt_template = get_template(template_name)
    ...
    def from_config(
        ...
        root_dataset_dir: Path,
        model_cache_dir: constants.CACHE_DIR
    ):
        """
        ...
        if not self._debug:
            comet_llm.log_prompt(
                ...
                metadata={
                    ...
                    "input.model": self._model_id,
                    "input.peft_mode": self._peft_model_id
                },
    ...
    def infer_all(self, output_file: Optional[Path]=None) -> None:
        ...
        if should_save_output:
            utils.write_json(prompt_answers, output_file)